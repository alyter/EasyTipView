...
#ifndef ZMLKIT_SWIFT_H
#define ZMLKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ZMLKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6ZMLKit7XMLNode")
...
@interface XMLNode (SWIFT_EXTENSION(ZMLKit)) <NSXMLParserDelegate>
